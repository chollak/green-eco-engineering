...
export function catalogPage () {
  ...
  <div class="page stack">
    ...
    ${el('p', 't-lead', {
      ru: `Полный перечень: ${SECTION_COUNT} направлений, ${SERVICE_COUNT} ${pluralKind(SERVICE_COUNT)} работ. Сгруппированы по этапу жизни объекта — от ввода питания до эксплуатации, а не по алфавиту.`,
      uz: `To‘liq ro‘yxat: ${SECTION_COUNT} yo‘nalish, ${SERVICE_COUNT} ta ish turi. Alifbo bo‘yicha emas, obyekt hayoti bosqichi bo‘yicha guruhlangan — quvvat kiritishdan ekspluatatsiyagacha.`
    })}
    <div class="filter">
      ...
      <p class="filter__count" data-filter-count aria-live="polite" aria-atomic="true"></p>
    </div>
  </div>
</section>
...
${contactBand('../')}`
  ...
  return page({
    base: '../',
    title: {
      ru: `Каталог работ: ${SECTION_COUNT} направлений, ${SERVICE_COUNT} видов — GREEN ECO`,
      uz: `Ishlar katalogi: ${SECTION_COUNT} yo‘nalish, ${SERVICE_COUNT} tur — GREEN ECO`
    },
    description: {
      ...
      uz: `Elektromontaj ishlarining to‘liq katalogi: montaj va yuqori kuchlanish, ishga tushirish, elektrolaboratoriya, yong‘in xavfsizligi, avtomatika, xizmat ko‘rsatish. ${SERVICE_COUNT} ta ish turi.`
    },
